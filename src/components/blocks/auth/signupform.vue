<template>
  <div class="mx-4 text-gray-200 md:w-[400px] md:mx-auto">
    <div class="my-20">
      <FormKit
        id="login"
        type="form"
      ...
      >
        ...
        <p
          class="description mb-5 text-base font-semibold mt-4 text-center leading-8"
        >
        ...
        >
          <template #label>
            <div class="w-full flex justify-between items-center">
              <p class="text-md text-gray-200 my-2">
      ...
      <p class="w-full text-center">
        Already a user ?
        <router-link to="/"
          ><span class="text-primary text-sm px-2 cursor-pointer">
            Sign In</span
          ></router-link
        >
      </p>
...
const handleIconClick = (node: any, e: any) => {
  node.props.suffixIcon =
    node.props.suffixIcon === eyeIcon ? eyeClosed : eyeIcon;
